...
public class SquareWaveOscillator extends Oscillator
{

	public SquareWaveOscillator(int Samplerate, int Buffersize)
	{
	...
	{
		return new SquareWaveOscillator(samplerate,buffersize);
	}
