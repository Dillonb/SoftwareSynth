...
public class JaggedSquareWaveOscillator extends Oscillator
{

	public JaggedSquareWaveOscillator(int Samplerate, int Buffersize)
	{
	...
	protected void oscillate(int buffersize)
	{
		...
		{
			if (goingUp)
				lastsample = amplitude; //Square wave code
			else
				lastsample = (short)(amplitude * -1); //Square wave code
	...
	{
		return new JaggedSquareWaveOscillator(samplerate,buffersize);
	}

	@Override
	public String getType()
	{
		return "JaggedSquareWaveOscillator";
	}
